...
public class KunjunganActivity extends AppCompatActivity {
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(KunjunganActivity.this, REQUEST_CHECK_SETTINGS);
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(KunjunganActivity.this, errorMessage, Toast.LENGTH_LONG).show();
                        }
    ...
    @OnClick(R.id.button_simpan_kunjungan) void kunjungan() {
        ...
        progress = ProgressDialog.show(KunjunganActivity.this,"Proses Kunjungan","Please Wait",false,false);
        ...
        Call<Value> call = api.kunjungan(namaoutlet, ket, LocationLong, LocationLat, kodeImei, img_new_name);
    ...
    public void UploadImageToServer(){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                KunjunganActivity.ImageProcessClass imageProcessClass = new KunjunganActivity.ImageProcessClass();
